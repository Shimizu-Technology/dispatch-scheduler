module DispatchTestData
  ...
  def reset_dispatch_records
    [ FollowUp, DispatchItem, DispatchSchedule, WorkOrder, PmTask, TeamMembership, TeamDailyOverride, TechnicianAvailability, TechnicianSkill, Technician, Team, Location, Client, User ].each(&:delete_all)
  end
